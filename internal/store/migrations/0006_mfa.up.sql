-- 0006_mfa.up.sql
-- Multi-factor authentication: enrolled methods, backup codes, and
-- propagation of the authentication context onto sessions.
...
CREATE TABLE user_mfa_methods (
    ...
    -- User-supplied label, e.g. "iPhone", "YubiKey 5C".
    name          text        NULL,

    -- TOTP fields
    secret        text        NULL,  -- base32, RFC 6238

    -- WebAuthn fields
    credential    jsonb       NULL,  -- serialized webauthn.Credential
...
CREATE INDEX user_mfa_methods_user_idx
...
-- Lookup index for active (unused) codes per user.
